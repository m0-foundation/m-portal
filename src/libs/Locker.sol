...
/**
 * @author Uniswap Labs.
 *         Adapted from https://github.com/Uniswap/v4-periphery/blob/main/src/libraries/Locker.sol for Moca deployment.
 * @dev    Use Uniswap version of the contract when Moca supports transient storage.
 */
library Locker {
